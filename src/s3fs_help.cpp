...
static const char help_string[] = 
    ...
    "      - By default ossfs memorizes when an object does not exist up until\n"
    "        the stat cache timeout.  This caching can cause staleness for\n"
    "        applications.  If disabled, ossfs will not memorize objects and may\n"
    ...
    "      use_session_token, and ram_role option.\n"
    "\n"
    ...
    "\n"
    "   auto_create_bucket (default is disable)\n"
    "        Automatically create the bucket if it does not exist when mounting.\n"
    "        If the bucket already exists, it is also considered successful.\n"
    "\n"
    "   agentic_bucket=<name>\n"
    "        Set the x-oss-agentic-bucket header with the specified name when\n"
    "        creating the bucket automatically. This option is used in conjunction\n"
    "        with the auto_create_bucket option.\n"
    "\n"
    ...
    "        Note that this option only works when direct_read option is true.\n"
    "\n"
    "   direct_read_backward_chunks (default is 1)\n"
    "        Specifies the number of chunks reserved of backward direction.\n"
    "        Note that this option only works when direct_read option is true.\n"
    "\n"
    "   direct_read_local_file_cache_size_mb (default is 0)\n"
    "        Takes effect only in direct-read mode.\n"
    "        When loaded size is smaller than it, ossfs prefetches and writes data to the local disk.\n"
    "        When loaded size is larger than it, ossfs enters direct-read mode.\n"
    "\n"
    ...
    "\n"
    "   sigv4 (default is signature version 1)\n"
    "      - sets signing OSS requests by using only signature version 4.\n"
    "\n"
    "   cloudbox_id (default is empty)\n"
    "      - sets the cloud box id when oss is on cloudbox.\n"
    "      Usage: -ocloudbox_id=\"cloudbox_id\".\n"
    "\n"
    "   region (default=\"cn-hangzhou\")\n"
    "      - sets the region to use on oss signature version 4.\n"
    "      If you use oss signature version 4, you must set region.\n"
    "      If this option is not specified, ossfs could not run. \n"
    "\n"
    "FUSE/mount Options:\n"
    "\n"
