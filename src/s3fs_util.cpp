...
void show_help (void)
{
  ...
  printf(
    ...
    "     -  This option instructs ossfs to enable requests involving Requester Pays buckets.\n"
    "        It includes the 'x-oss-request-payer: requester' entry in the request header.\n"
    "\n"
