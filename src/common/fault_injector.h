...
typedef enum {
  ...
  FI_Readdir_Delay_Before_Construct,
  ...
  FI_Do_Refill_Range_Delay_Before_Release,
  FI_DiskCache_Init_Failure,
  FI_DiskCache_Key_Collision,
  FI_HdfsOpen_WriterFail,
  FI_HdfsOpen_ReaderFail,
  FI_HdfsClose_WriterFail,
  FI_HdfsClose_IdleWriterFail,
  FI_HdfsClose_ReaderFail,
  FI_HdfsReaderRebuild_ReopenFail,
  FI_HdfsFdatasync_FlushFail,
  FI_HdfsPread_SeekFail,
  FI_HdfsPread_ReadFail,
  FI_HdfsWrite_SeekFail,
  FI_HdfsWriteBuf_ReadError,
  FI_Check_Bucket_List_Not_Found,
  FI_HdfsSymlink_BadTarget,
  FI_HdfsSymlink_EscapePath,
  FI_HdfsSymlink_SiblingPrefix,
  FI_HdfsRename_PreDeleteFail,
  FI_Hdfs_UserGroup_Mapping,
  FI_Hdfs_LoginUser_Override,
  FI_Pwrite_Staging_Short_Write,
  FI_Pwrite_Staging_Fail,
  FI_Modify_Staging_Data,
  FI_RandomWrite_Get_Chunk_Fail,
  FI_RandomWrite_Init_Multipart_Fail,
  FI_RandomWrite_Complete_Multipart_Fail,
  FI_RandomWrite_Copy_Part_No_Crc,
  FI_Upload_BodyWriter_Partial_Fail,
  FI_Count,
} FaultInjectionId;
